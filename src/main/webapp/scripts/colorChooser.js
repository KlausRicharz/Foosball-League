	...
	CLCPinitPicker = function() {
		...
		$S("CLCP").width = "262px";
		$S("CLCP").height = "268px";
		$("CLCP").innerHTML = "<div id=\"CLCPDragDiv\" class=\"CLCPDragDiv\">"+
		  "  <div id=\"CLCPIinnerShell\" class=\"CLCPIinnerShell\">"+
		  "    <div id=\"CLCPPicker\" class=\"CLCPPicker\">"+
		  "      <div id=\"CLCPSatVal\" class=\"CLCPSatVal\" onmousedown=\"CLCPslide('CLCPSatValSlide','CLCPPicker',event);\">"+
		  "        <div id=\"CLCPSatValSlide\" class=\"CLCPSatValSlide\"></div>"+
		  "      </div>"+
		  "      <div id=\"CLCPHueContainer\" class=\"CLCPHueContainer\" onmousedown=\"CLCPslide('CLCPHueSlide','CLCPPicker',event);\">"+
		  "        <div id=\"CLCPHueSlide\" class=\"CLCPHueSlide\" style=\"top: -4px; left: -7px;\"></div>"+
		  "        <div class=\"CLCPHue\"></div>"+
		  "      </div>"+
		  "      <div id=\"CLCPSatContainer\" class=\"CLCPSatContainer\" onmousedown=\"CLCPslide('CLCPSatSlide','CLCPPicker',event);\">"+
		  "        <div id=\"CLCPSatSlide\" class=\"CLCPSatSlide\" style=\"top: -4px; left: -7px;\"></div>"+
		  "        <div id=\"CLCPSat\" class=\"CLCPSat\"></div>"+
		  "      </div>"+
		  "      <div id=\"CLCPValContainer\" class=\"CLCPValContainer\" onmousedown=\"CLCPslide('CLCPValSlide','CLCPPicker',event);\">"+
		  "        <div id=\"CLCPValSlide\" class=\"CLCPValSlide\" style=\"top: -4px; left: -7px;\"></div>"+
		  "        <div id=\"CLCPVal\" class=\"CLCPVal\"></div>"+
		  "      </div>"+
		  "    </div>"+
		  "    <div class=\"CLCPbPE\">"+
		  "      <div style=\"width: 48px; margin-right: 10px; background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/hex.png) center top no-repeat;\"></div>"+
		  "      <div style=\"background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/r.png) center top no-repeat;\"></div>"+
		  "      <div style=\"background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/g.png) center top no-repeat;\"></div>"+
		  "      <div style=\"margin-right: 11px; background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/b.png) center top no-repeat;\"></div>"+
		  "      <div style=\"background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/h.png) center top no-repeat;\"></div>"+
		  "      <div style=\"background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/s.png) center top no-repeat;\"></div>"+
		  "      <div style=\"margin-right: 0; background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/v.png) center top no-repeat;\"></div>"+
		  "      <div class=\"CLCPClear CLCPNoDim\"></div>"+
		  "      <input type=\"text\" id=\"CLCPbasicHex\" maxlength=\"6\" value=\"\" style=\"width: 48px; margin-right: 12px; background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/formFieldLargeBG.png) no-repeat;\" />"+
		  "      <input type=\"text\" id=\"CLCPbasicR\" maxlength=\"3\" />"+
		  "      <input type=\"text\" id=\"CLCPbasicG\" maxlength=\"3\" />"+
		  "      <input type=\"text\" id=\"CLCPbasicB\" maxlength=\"3\" style=\"margin-right: 13px;\" />"+
		  "      <input type=\"text\" id=\"CLCPbasicH\" maxlength=\"3\" />"+
		  "      <input type=\"text\" id=\"CLCPbasicS\" maxlength=\"3\" />"+
		  "      <input type=\"text\" id=\"CLCPbasicV\" maxlength=\"3\" style=\"margin-right: 0;\" />"+
		  "      <div class=\"CLCPClear\" style=\"width: 242px; height: 15px; margin: 0; font-size: 0;\"></div>"+
		  "      <div style=\"background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/c.png) center top no-repeat;\"></div>"+
		  "      <div style=\"background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/m.png) center top no-repeat;\"></div>"+
		  "      <div style=\"background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/y.png) center top no-repeat;\"></div>"+
		  "      <div style=\"background: url(http://colourlovers.com.s3.amazonaws.com/images/copaso/basic/k.png) center top no-repeat;\"></div>"+
		  "      <div class=\"CLCPClear CLCPNoDim\"></div>"+
		  "      <div>"+
		  "        <input type=\"text\" id=\"CLCPbasicC\" maxlength=\"3\" />"+
		  "      </div>"+
		  "      <div>"+
		  "        <input type=\"text\" id=\"CLCPbasicM\" maxlength=\"3\" />"+
		  "      </div>"+
		  "      <div>"+
		  "        <input type=\"text\" id=\"CLCPbasicY\" maxlength=\"3\" />"+
		  "      </div>"+
		  "      <div>"+
		  "        <input type=\"text\" id=\"CLCPbasicK\" maxlength=\"3\" />"+
		  "      </div>"+
		  "      <a href=\"http://www.colourlovers.com/\" target=\"_blank\">"+
		  "        <img src=\"http://colourlovers.com.s3.amazonaws.com/images/floatingColorPicker/logo.png\" style=\"float: left; width: 99px; height: 20px; border: 0 none;\" title=\"COLOURlovers\" alt=\"COLOURlovers\" />"+
		  "      </a>"+
		  "      <img src=\"http://colourlovers.com.s3.amazonaws.com/images/floatingColorPicker/closeBtn.png\" style=\"float: left; width: 13px; height: 13px; margin: 7px 0 0 12px; cursor: pointer;\" onclick=\"CLCPhidePicker();\" alt=\"Close\" />"+
		  "    </div>"+
		  "  </div>"+
		  "</div>";
